...
public class ServiceRequest implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "service_request_services",
    ...
    public ServiceRequest services(Set<Service> services) {
        this.services = services;
        return this;
    }

    public ServiceRequest addServices(Service service) {
        this.services.add(service);
        service.getServiceRequests().add(this);
        return this;
    }

    public ServiceRequest removeServices(Service service) {
        this.services.remove(service);
        service.getServiceRequests().remove(this);
        return this;
    }
