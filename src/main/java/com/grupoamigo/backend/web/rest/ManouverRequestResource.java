...
public class ManouverRequestResource {
    ...
    public ManouverRequestResource(ManouverRequestRepository manouverRequestRepository) {
    ...
    public List<ManouverRequest> getAllManouverRequests(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all ManouverRequests");
        return manouverRequestRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<ManouverRequest> getManouverRequest(@PathVariable Long id) {
        ...
        Optional<ManouverRequest> manouverRequest = manouverRequestRepository.findOneWithEagerRelationships(id);
