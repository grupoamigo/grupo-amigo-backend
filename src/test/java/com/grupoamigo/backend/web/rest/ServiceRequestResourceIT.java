...
public class ServiceRequestResourceIT {
    ...
    public void setup() {
        ...
        final ServiceRequestResource serviceRequestResource = new ServiceRequestResource(serviceRequestRepository);
    ...
    public void getAllServiceRequestsWithEagerRelationshipsIsEnabled() throws Exception {
        ServiceRequestResource serviceRequestResource = new ServiceRequestResource(serviceRequestRepositoryMock);
        when(serviceRequestRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
        ...
        verify(serviceRequestRepositoryMock, times(1)).findAllWithEagerRelationships(any());
    }
