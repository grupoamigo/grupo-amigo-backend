...
import CountryCodeComponentsPage from './country-code.page-object';
import { CountryCodeDeleteDialog } from './country-code.page-object';
...
describe('CountryCode e2e test', () => {
  ...
  it('should create and save CountryCodes', async () => {
    async function createCountryCode() {
      ...
      await countryCodeUpdatePage.locationSelectLastOption();
