...
describe('ManouverRequest e2e test', () => {
  ...
  it('should create and save ManouverRequests', async () => {
    async function createManouverRequest() {
      ...
      await manouverRequestUpdatePage.transportSelectLastOption();
      await manouverRequestUpdatePage.setPriceInput('5');
      expect(await manouverRequestUpdatePage.getPriceInput()).to.eq('5');
      await manouverRequestUpdatePage.currencySelectLastOption();
      ...
      await manouverRequestUpdatePage.manouverClientSelectLastOption();
      // manouverRequestUpdatePage.loadSelectLastOption();
