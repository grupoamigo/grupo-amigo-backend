...
import ServiceRequestComponentsPage from './service-request.page-object';
import { ServiceRequestDeleteDialog } from './service-request.page-object';
...
describe('ServiceRequest e2e test', () => {
  ...
  it('should create and save ServiceRequests', async () => {
    async function createServiceRequest() {
      ...
      // serviceRequestUpdatePage.servicesSelectLastOption();
