...
import StateCodeComponentsPage from './state-code.page-object';
import { StateCodeDeleteDialog } from './state-code.page-object';
...
describe('StateCode e2e test', () => {
  ...
  it('should create and save StateCodes', async () => {
    async function createStateCode() {
      ...
      await stateCodeUpdatePage.locationSelectLastOption();
